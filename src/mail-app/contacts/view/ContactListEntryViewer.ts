...
import { lang, ResolvedTranslation } from "../../../common/misc/LanguageViewModel.js"
...
export function getContactListEntriesSelectionMessage(selectedEntities: ContactListEntry[] | undefined): ResolvedTranslation {
	if (selectedEntities && selectedEntities.length > 0) {
		return lang.getResolved("nbrOfEntriesSelected_msg", { "{nbr}": selectedEntities.length })
	} else {
		return lang.getResolved("noSelection_msg")
	}
}
