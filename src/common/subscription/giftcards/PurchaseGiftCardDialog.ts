...
import { lang, ResolvedTranslation } from "../../misc/LanguageViewModel"
		...
		if (e instanceof PreconditionFailedError) {
			...
			switch (message) {
				case "giftcard.limitreached":
					throw new UserError(
						lang.getResolved("tooManyGiftCards_msg", {
...
class GiftCardPurchaseView implements Component<GiftCardPurchaseViewAttrs> {
	...
	private getGiftCardHelpText(upgradePrice: number, giftCardValue: number): ResolvedTranslation {
		...
		return lang.getResolved(helpTextId, {
