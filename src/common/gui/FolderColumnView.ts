...
import type { TranslationKey, TranslationText } from "../misc/LanguageViewModel.js"
...
export class FolderColumnView implements Component<Attrs> {
	view({ attrs }: Vnode<Attrs>): Children {
		return m(".flex.height-100p.nav-bg", [
			...
			m(".folder-column.flex-grow.overflow-x-hidden.flex.col", landmarkAttrs(AriaLandmarks.Navigation, lang.resolveToTranslation(attrs.ariaLabel)), [
