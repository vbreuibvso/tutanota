...
import type { InfoLink, TranslationKey, TranslationText } from "../../misc/LanguageViewModel"
 ...
 */
export function getConfirmation(message: TranslationText, confirmMessage: TranslationKey = "ok_action"): Confirmation {
